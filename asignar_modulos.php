        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Gesti&oacute;n de Asignaci&oacute;n de Modulos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title" id="leyenda">Asignar modulo al emisor</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <select class="form-control" id="emisor" onfocus="resetear('emisor')" onchange="ver_modulos();">
                    ...
                    <br><h6><i class="fas fa-brain"></i> Selecciona el modulo</h6><hr>
                    <div class="row">
                        <div class="col-6">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <select class="form-control" id="modulo" onfocus="resetear('modulo')">
                                    <option value="0">Selecciona el modulo a relacionar</option>
                                    <?php
                                        $consultaModulo = "SELECT id_modulo, nombre_modulo FROM _cat_erp_modulos WHERE estatus = 1 ORDER BY nombre_modulo ASC";
                                        $resModulo = mysqli_query($conexion, $consultaModulo);
                                        while($modulo = mysqli_fetch_array($resModulo))
                                        {
                                            echo "<option value='".$modulo['id_modulo']."'>[".$modulo['id_modulo']."] ".$modulo['nombre_modulo']."</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                    ...
                    <br>
                    <center><button type="button" class="btn btn-info" onclick="gestionar_asignaciones();" id="btn_emisor">Guardar informaci&oacute;n</button></center>
                </div>
            </div>
            <br>
...
<script src="js/peticiones_asignaciones.js"></script>

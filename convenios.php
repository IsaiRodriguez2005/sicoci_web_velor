...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Gesti&oacute;n de Convenios</li>
                                </ol>
                                <button type="button" class="btn btn-danger" onclick="ver_catalogo();">Ver Convenios</button>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title" id="leyenda">Registro de nuevo convenio</h3>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Nombre de la persona, empresa, organizaci&oacute;n o instituci&oacute;n" id="nombre" onfocus="resetear('nombre')" maxlength="150">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control" id="tipo" name="tipo" required onchange="select_tipo_desc()" onfocus="resetear('tipo')">
                                                <option value="" selected disabled>Selecciona Opci&oacute;n</option>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="Costo de consulta" id="cost_consul" onfocus="resetear('cost_consul')" min="0" disabled>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group mb-3">
        ...
        <script src="js/peticiones_convenios.js"></script>

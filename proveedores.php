...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-danger" onclick="ver_catalogo();">Ver Proveedores</button>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title" id="leyenda">Registro de nuevo proveedor</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-8">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nombre del proveedor" id="nombre_comercial" onfocus="resetear('nombre_comercial')" maxlength="150" require>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <center><button type="button" class="btn btn-success btn-lg" onclick="gestionar_proveedor();">Guardar Proveedor</button></center><br><br><br>
                            <!-- INICIA MODAL MODAL PARA EDITAR CLIENTE -->
                            <div class="modal fade" id="modal_proveedores" role="dialog" style="overflow: scroll;">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title text-success">Proveedores Registrados</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-12 table-responsive" id="vista_proveedores"></div>
                                            </div>
                                        </div>
        ...
        <script src="js/peticiones_proveedores.js"></script>

        ...
        $html .= "
                <tr id='tr_" . $permiso['id_permiso'] . "'>
                    ...
                    <td class='text-center'>
                        <div class='btn-group'>
                            <button type='button' id='btn_edit_" . $permiso['id_permiso'] . "' class='btn btn-warning btn-sm' " . $boton_editar . " title='Editar cita' onclick='editar_cita()'>
                                <i class='fas fa-pencil-alt'></i>
                            </button>
                            &nbsp;
                            
                            <button type='button' id='btn_can_" . $permiso['id_permiso'] . "' class='btn btn-danger btn-sm' " . $boton_cancelar . " title='Cancelar cita' onclick='cancelar_permiso()'>

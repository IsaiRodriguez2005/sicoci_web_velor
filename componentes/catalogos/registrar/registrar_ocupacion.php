...
if (empty($_SESSION['id_usuario']) || empty($_SESSION['nombre_usuario'])) {
    ...
    if ($_POST['nombre_ocupacion']) {
        ...
        $checkOcupacion = "SELECT COUNT(*) as count FROM emisores_ocupaciones WHERE id_emisor = " . $_SESSION['id_emisor'] . " AND nombre_ocupacion = '" . strtoupper($_POST['nombre_ocupacion']) . "'";
        $resultado =  mysqli_query($conexion, $checkOcupacion);

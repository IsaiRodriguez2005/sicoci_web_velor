                        ...
                        <tr>
                            <td class='text-center'>
                                <div class='btn-group' id='div-check".$clientes['id_perfil']."'>
                                    <button type='button' class='btn btn-primary btn-sm' ".$disabled_edicion." title='Perfiles de facturaci&oacute;n' onclick='cargar_perfil(".$clientes['id_perfil'].", &quot;".$clientes['nombre_social']."&quot;)'>
                                    ...
                                    &nbsp;
                                    <button type='button' class='btn ".$color." btn-sm' title='".$titulo."' onclick='actualizar_estatus_cliente(".$clientes['id_perfil'].",".$codigo_estatus.");'>
                                        ".$desactive."
                                    </button>
                                </div>
                            </td>
